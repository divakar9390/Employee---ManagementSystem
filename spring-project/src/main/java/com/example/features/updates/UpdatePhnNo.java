...
public class UpdatePhnNo {
    public static void UpdatePhnNo(Scanner scanner, EmployeeService employeeService){
        try {
            ...
            if(authentication){
                ...
                int rows = employeeService.updatePhoneNo(updateEmployee);
                if(rows>=1){
